...
class UserCardsSingleBlocScreen extends StatelessWidget {
  const UserCardsSingleBlocScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Single State Bloc")),
      body: Center(
        child: BlocBuilder<SingleStateBloc,SingleBlocState>(
