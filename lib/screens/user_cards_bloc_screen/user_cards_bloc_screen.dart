...
import '../../bloc/multi_state_bloc/multi_bloc_state.dart';

class UserCardsBlocScreen extends StatelessWidget {
  const UserCardsBlocScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<UserCardsBloc, UserCardsBlocState>(
      builder: (context, state) {
        return Scaffold(
          ...
          body: Column(
            ...
            children: [
              state is LoadUserCardsBlocInProgress
                  ? const Center(child: CircularProgressIndicator())
                  : state is LoadUserCardsBlocInSuccess
                  ? Expanded(
                child: ListView.builder(
                  ...
                  : state is LoadUserCardsBlocInFailure
                  ? Center(
